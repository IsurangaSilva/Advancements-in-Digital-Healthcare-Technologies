...
const voiceAggregationSchema = new mongoose.Schema(
  {
...
const Voice_Emotion_Aggregate = connection.model(
  "voice-emotion-aggregates",voiceAggregationSchema
);

module.exports = Voice_Emotion_Aggregate;
